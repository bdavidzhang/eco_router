#!/usr/bin/env bash
# run_10min_30s_iter.sh — 10-minute autonomous research run (30s iterations)
#
...
#
# Usage:
#   ./run_10min_30s_iter.sh                         # defaults: auto strategy, us_average grid
#   ./run_10min_30s_iter.sh --region eu_france     # French nuclear grid (55 gCO₂/kWh)
#   ./run_10min_30s_iter.sh --strategy random       # force random search
#   ./run_10min_30s_iter.sh --minutes 5             # shorter run
#   SENSOR_INTERVAL=2 ./run_10min_30s_iter.sh       # 2s sensor sampling
#
...
cat << 'BANNER'
  ...
  ╔══════════════════════════════════════════════════════════════╗
  ║  🔬 Auto-Improving LLM Research Workbench (30s iter)  ║
  ╚══════════════════════════════════════════════════════════════╝
